import { a2 as attr_class, U as clsx$1, a4 as escape_html } from './index-server.js-G-77DcSL.js';
...
function Section_heading($$renderer, $$props) {
	...
	if (subtitle) {
		$$renderer.push("<!--[0-->");
		$$renderer.push(`<p class="mt-4 font-sans text-lg text-muted-foreground italic opacity-90 md:text-xl">${escape_html(subtitle)}</p>`);
	} else $$renderer.push("<!--[-1-->");
	$$renderer.push(`<!--]--></div>`);
}

export { Section_heading as S };
//# sourceMappingURL=section-heading.js-BbSbdCg2.js.map
