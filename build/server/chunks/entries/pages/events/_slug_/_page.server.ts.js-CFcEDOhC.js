import { r as db, N as eventRegistrations } from '../../../../chunks/db.js-CPhQsSSC.js';
import { h as getEventBySlug, g as getSettings, i as getEventGallery } from '../../../../chunks/content.js-DdRtddEa.js';
...
import { o as object, d as string, n as number, e as email } from '../../../../chunks/auth.js-CCGW_diT.js';
...
var load = async ({ params }) => {
	...
	const [form, gallery] = await Promise.all([superValidate(zod(registrationSchema)), getEventGallery(event.id)]);
	return {
		event,
		form,
		gallery
...
//# sourceMappingURL=_page.server.ts.js-CFcEDOhC.js.map
