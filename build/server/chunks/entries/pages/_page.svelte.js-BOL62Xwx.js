import { Y as head, V as ensure_array_like, a4 as escape_html, a5 as attr_style, _ as spread_props, F as derived, X as attr, a3 as stringify } from '../../chunks/index-server.js-G-77DcSL.js';
...
import { C as Carousel, a as Carousel_content, b as Carousel_item, c as Carousel_previous, d as Carousel_next } from '../../chunks/GalleryLightbox.js-D11cBi9E.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--></div></div></section> <section class="atmosphere py-8 lg:py-20"><div class="container mx-auto px-4 sm:px-6"><div class="grid items-center lg:gap-12 gap-4 lg:grid-cols-2"><div>`);
		...
		if (data.dishes.length) {
			...
			$$renderer.push(`<!----> <div class="lg:mt-16 mt-4 grid gap-8 sm:grid-cols-3 sm:items-stretch"><!--[-->`);
		...
		if (data.events.length) {
			...
			$$renderer.push(`<!----></div> <div class="lg:mt-8 text-center">`);
			Button($$renderer, {
				href: "/events",
				variant: "link",
...
//# sourceMappingURL=_page.svelte.js-BOL62Xwx.js.map
