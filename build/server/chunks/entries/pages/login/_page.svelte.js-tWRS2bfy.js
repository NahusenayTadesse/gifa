import { Y as head, X as attr, ac as store_get, ad as store_mutate, a4 as escape_html, F as derived, _ as spread_props, af as unsubscribe_stores } from '../../../chunks/index-server.js-G-77DcSL.js';
...
import { C as Card, b as Card_header, c as Card_title, d as Card_description, a as Card_content } from '../../../chunks/card.js-DuOddC8W.js';
...
function Login($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		const { form, errors, allErrors} = superForm(data, { onError: toastOnError });
							...
							Card_content($$renderer, {
								children: ($$renderer) => {
									...
									if (store_get($$store_subs ??= {}, "$errors", errors).email) {
										$$renderer.push("<!--[0-->");
										$$renderer.push(`<span class="text-sm text-destructive">${escape_html(store_get($$store_subs ??= {}, "$errors", errors).email)}</span>`);
									...
									if (store_get($$store_subs ??= {}, "$errors", errors).password) {
										$$renderer.push("<!--[0-->");
										$$renderer.push(`<span class="text-sm text-destructive">${escape_html(store_get($$store_subs ??= {}, "$errors", errors).password)}</span>`);
									} else $$renderer.push("<!--[-1-->");
...
//# sourceMappingURL=_page.svelte.js-tWRS2bfy.js.map
