import { r as db, G as bookings } from '../../../chunks/db.js-CPhQsSSC.js';
import { g as getSettings, b as getHero } from '../../../chunks/content.js-DdRtddEa.js';
...
import { o as object, d as string, n as number, e as email, l as literal } from '../../../chunks/auth.js-CCGW_diT.js';
...
var actions = { book: async ({ request }) => {
	...
	if (requested.getTime() === today.getTime()) {
		...
		const requestedDateTime = /* @__PURE__ */ new Date();
		requestedDateTime.setHours(hours, minutes, 0, 0);
		if (Number.isNaN(requestedDateTime.getTime()) || requestedDateTime < /* @__PURE__ */ new Date()) return message(form, {
			type: "error",
			text: "That time's already passed today — please choose a later time."
		}, { status: 400 });
	}
...
//# sourceMappingURL=_page.server.ts.js-Dk4BImdP.js.map
