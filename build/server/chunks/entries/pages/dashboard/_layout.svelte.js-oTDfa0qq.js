import { a0 as bind_props, E as setContext, F as derived, T as attributes, U as clsx$1, a3 as stringify, _ as spread_props, M as getContext, X as attr, a2 as attr_class, V as ensure_array_like, a4 as escape_html, aa as props_id } from '../../../chunks/index-server.js-G-77DcSL.js';
import { o as on } from '../../../chunks/legacy-client.js-DyVQ66Cr.js';
import { M as MediaQuery } from '../../../chunks/index-server2.js-BPx0mTfA.js';
import { h as createBitsAttrs, u as createId, a as boxWith, l as attachRef, q as mergeProps, n as boolToEmptyStrOrUndef, m as getDataOpenClosed, o as boolToStr, p as getDataTransitionAttrs } from '../../../chunks/create-id.js-Pl6wo96w.js';
import { g as goto } from '../../../chunks/client.js-BE73K9-j.js';
...
import { I as Image$1 } from '../../../chunks/image.js-DhjcWPLt.js';
import { M as Mail } from '../../../chunks/mail.js-CknIL-37.js';
import { P as Party_popper } from '../../../chunks/party-popper.js-DBPdNKhP.js';
import { S as Search, C as Command, a as Command_input, b as Command_list, c as Command_empty, d as Command_group, e as Command_link_item } from '../../../chunks/command.js-Dz__iECm.js';
...
import { t as tv, c as cn, B as Button } from '../../../chunks/button.js-CVHOzf19.js';
import { n as noop, P as PresenceManager, a as afterTick } from '../../../chunks/noop.js-BLOEitT-.js';
import '../../../chunks/LoadingBtn.js-BFpbCOtB.js';
import { C as Context, w as watch } from '../../../chunks/is.js-LX4C4ueF.js';
import { P as Portal, d as DOMContext } from '../../../chunks/scroll-lock.js-B2UsFhK8.js';
import { D as Dialog$1, a as Dialog_content$1, b as Dialog_close, d as Dialog_overlay, e as Dialog_title$1 } from '../../../chunks/dialog-content.js-Bk31zkZ0.js';
...
import { D as Dialog_description } from '../../../chunks/dialog-description.js-B7R2haCG.js';
import { T as Tooltip_provider } from '../../../chunks/tooltip.js-DG5RmUXX.js';
...
import { D as DarkMode } from '../../../chunks/DarkMode.js-DbTppBP8.js';
...
import '../../../chunks/sun.js-D_GqxHtv.js';
import '../../../chunks/dist.js-0_pi50Yw.js';

//#region node_modules/.pnpm/@lucide+svelte@1.28.0_svelte@5.56.8_@typescript-eslint+types@8.65.0_/node_modules/@lucide/svelte/dist/icons/calendar-check.svelte
...
//#endregion
//#region node_modules/.pnpm/@lucide+svelte@1.28.0_svelte@5.56.8_@typescript-eslint+types@8.65.0_/node_modules/@lucide/svelte/dist/icons/megaphone.svelte
...
function App_sidebar($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
				...
				items: [
					{
						...
						items: [{
							...
							url: "/dashboard/content/menu-categories"
						}]
					},
					{
						title: "Gallery",
					...
					},
					{
						...
						items: [{
							...
							title: "Event Gallery",
							url: "/dashboard/content/event-gallery"
						}]
					},
					{
						title: "Opening Hours",
						url: "/dashboard/content/opening-hours",
						icon: Clock
					},
					{
						title: "Announcements",
      ...
      ${stringify(bgGradient)}`,
								children: ($$renderer) => {
									$$renderer.push(`<div class="sticky top-0 z-10 border-b border-border/60 px-4 py-4"><a href="/" title="Go to Website Home Page" class="flex flex-row flex-wrap gap-2" target="_blank"><img src="/logo.webp" alt="Logo" class="h-4 rounded-[1px]"/> <div><div class="text-[13px] font-medium tracking-tight text-foreground">Admin Panel</div> <div class="text-[10px] tracking-widest text-muted-foreground uppercase">Dashboard</div></div></a></div> <div class="flex-1 py-2">`);
									NavMain($$renderer, {
										sections: navigation
									});
									$$renderer.push(`<!----></div>`);
...
function Search_1($$renderer) {
	...
	let list = [
		...
		{
			label: "Menu Items",
			path: "/dashboard/content/menu-items"
		},
		{
			label: "Menu Categories",
			path: "/dashboard/content/menu-categories"
		},
		{
			label: "Gallery",
		...
		{
			label: "Opening Hours",
			path: "/dashboard/content/opening-hours"
		},
		{
			label: "Announcements",
...
//# sourceMappingURL=_layout.svelte.js-oTDfa0qq.js.map
