import { r as db, w as menuItems, m as eq, B as menuCategories, a as asc, M as getTableColumns } from '../../../../../chunks/db.js-CPhQsSSC.js';
import { s as superValidate } from '../../../../../chunks/client2.js-ccjA_ZCz.js';
...
import { o as object, k as boolean, n as number, g as boolean$1, d as string, j as file } from '../../../../../chunks/auth.js-CzaJ0OJC.js';
...
var load = async () => {
	const [base, categories, toggleForm, rows] = await Promise.all([
		...
		}).from(menuItems).leftJoin(menuCategories, eq(menuItems.categoryId, menuCategories.id)).orderBy(asc(menuItems.sortOrder))
	]);
	return {
		...base,
		rows,
...
//# sourceMappingURL=_page.server.ts.js-DkOj8l3z.js.map
