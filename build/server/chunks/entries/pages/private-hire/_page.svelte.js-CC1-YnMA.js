import { Y as head, V as ensure_array_like, a4 as escape_html, X as attr, ac as store_get, af as unsubscribe_stores } from '../../../chunks/index-server.js-G-77DcSL.js';
import { I as InputComp } from '../../../chunks/InputComp.js-D9ih9EPq.js';
import { C as Check } from '../../../chunks/minus.js-Ca5wYkhY.js';
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--> <section class="py-14 sm:py-20"><div class="container mx-auto px-4 sm:px-6">`);
		...
		$$renderer.push(`<!--]--></div></div></section> <section class="relative isolate overflow-hidden py-14 sm:py-20"><div class="spotlight" style="--spot-x: 20%; --spot-y: 60%"></div> <div class="container mx-auto px-4 sm:px-6">`);
...
//# sourceMappingURL=_page.svelte.js-CC1-YnMA.js.map
